...
public class InvincibilityTests {
    ...
    public void aliveToInvincState() {
        ...
        Player player = new Player(0, new Position(0, 0), 1, 1, 4, 4, 4, 1, 1, 1);
        dungeon.addEntity(player);
        dungeon.setPlayer(player);
        player.addItem(new InvincibilityPotion(1, new Position(0, 0), 5));
        player.drinkInvinc(1);
        Mercenary merc = new Mercenary(2, new Position(0, 0), 100, 100, 100, 100, 100, 100);
